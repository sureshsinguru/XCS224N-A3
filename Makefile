...
#   Creates the A3_Solutions.pdf handout.  Removes auxiliary studenlatex files
#   after compilation.
# `make without_solutions`
#   Creates the A3.pdf handout.  Removes auxiliary latex files after
...
#
# $ latexmk -pvc -jobname="A3_Solutions"
#
# (Of course, substituting the "A3" for the assignment root document)
#
